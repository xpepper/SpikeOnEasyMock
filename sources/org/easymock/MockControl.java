...
/**
 * A <code>MockControl</code> object controls the behavior of its associated mock object. For more information, see
 * the EasyMock documentation.
 * 
 * @deprecated Since EasyMock 2.0, static methods on <code>EasyMock</code> are used to create and control mock
 *             objects.
 */
public class MockControl<T> {
    ...
    /**
     * Creates a mock control object for the specified interface. The <code>MockControl</code> and its associated mock
     * object will not check the order of expected method calls. An unexpected method call on the mock object will lead
     * to an <code>AssertionError</code>.
     * 
     * @param toMock the class of the interface to mock.
     * @return the mock control.
     */
    public static <T> MockControl<T> createControl(Class<T> toMock) {
        return new MockControl<T>((MocksControl) EasyMock.createControl(), toMock);
    }

    /**
     * Creates a mock control object for the specified interface. The <code>MockControl</code> and its associated mock
     * object will check the order of expected method calls. An unexpected method call on the mock object will lead to
    ...
    public static <T> MockControl<T> createStrictControl(Class<T> toMock) {
        return new MockControl<T>((MocksControl) EasyMock.createStrictControl(), toMock);
    }

    /**
     * Creates a mock control object for the specified interface. The <code>MockControl</code> and its associated mock
     * object will not check the order of expected method calls. An unexpected method call on the mock object will
    ...
    public static <T> MockControl<T> createNiceControl(Class<T> toMock) {
        return new MockControl<T>((MocksControl) EasyMock.createNiceControl(), toMock);
    }
     ...
     * 
     * @exception IllegalStateException if the mock object is in replay state, if no method was called on the mock
     *                    object before, or if the last method called on the mock was no void method.
     */
    ...
    /**
     * Records that the mock object will expect the last method call once, and will react by throwing the provided
     * Throwable.
     * 
     * @param throwable the Throwable to throw.
     * @exception IllegalStateException if the mock object is in replay state or if no method was called on the mock
     *                    object before.
     * @exception IllegalArgumentException if the last method called on the mock cannot throw the provided Throwable.
     * @exception NullPointerException if throwable is null.
     */
    ...
    /**
     * Records that the mock object will expect the last method call once, and will react by returning the provided
     * return value.
     * 
     * @param value the return value.
     * @throws IllegalStateException if the mock object is in replay state, if no method was called on the mock object
     *                 before. or if the last method called on the mock does not return <code>boolean</code>.
     */
    ...
    /**
     * Records that the mock object will expect the last method call a fixed number of times, and will react by
     * returning silently.
     * 
     * @param times the number of times that the call is expected.
     * @exception IllegalStateException if the mock object is in replay state, if no method was called on the mock
     *                    object before, or if the last method called on the mock was no void method.
     */
    ...
    /**
     * Records that the mock object will expect the last method call a fixed number of times, and will react by throwing
     ...
     * 
     * @param value the return value.
     * @param range the number of times that the call is expected.
     * @throws IllegalStateException if the mock object is in replay state, if no method was called on the mock object
     *                 before. or if the last method called on the mock does not return <code>boolean</code>.
     */
    public void setReturnValue(Object value, Range range) {
        IExpectationSetters setter = expectLastCall("method call on the mock needed before setting return value")
                .andReturn(value);
    ...
    /**
     * Records that the mock object will by default allow the last method specified by a method call, and will react by
    ...
    /**
     * Sets the ArgumentsMatcher for the last method called on the mock object. The matcher must be set before any
     * behavior for the method is defined.
     * 
    ...
    /**
     * Records that the mock object will expect the last method call between <code>minCount</code> and
     * <code>maxCount</code> times, and will react by returning silently.
     * 
     * @param minCount the minimum number of times that the call is expected.
     * @param maxCount the maximum number of times that the call is expected.
     * @exception IllegalStateException if the mock object is in replay state, if no method was called on the mock
     *                    object before, or if the last method called on the mock was no void method.
     */
    ...
    /**
     * Records that the mock object will expect the last method call between <code>minCount</code> and
     * <code>maxCount</code> times, and will react by throwing the provided Throwable.
     * 
     * @param throwable the Throwable to throw.
     * @param minCount the minimum number of times that the call is expected.
     * @param maxCount the maximum number of times that the call is expected.
    ...
    public void setThrowable(Throwable throwable, int minCount, int maxCount) {
        expectLastCall("method call on the mock needed before setting Throwable").andThrow(throwable).times(minCount,
                maxCount);
    }

    public void setThrowable(Throwable throwable, Range range) {
        IExpectationSetters setter = expectLastCall("method call on the mock needed before setting Throwable")
                .andThrow(throwable);
        callWithConvertedRange(setter, range);
    }
    ...
    /**
     * Records that the mock object will expect the last method call between <code>minCount</code> and
     * <code>maxCount</code> times, and will react by returning the provided return value.
     * 
     * @param value the return value.
     * @param minCount the minimum number of times that the call is expected.
     * @param maxCount the maximum number of times that the call is expected.
    ...
    public void setReturnValue(Object value, int minCount, int maxCount) {
        expectLastCall("method call on the mock needed before setting return value").andReturn(value).times(minCount,
                maxCount);
    }
    ...
    /**
     * Matches if each expected argument is equal to the corresponding actual argument for non-array arguments; array
     * arguments are compared with the appropriate <code>java.util.Arrays.equals()</code> -method.
     */
    public static final ArgumentsMatcher ARRAY_MATCHER = new ArrayMatcher();

    /**
     * Sets the default ArgumentsMatcher for all methods of the mock object. The matcher must be set before any behavior
     * is defined on the mock object.
     * 
     * @throws IllegalStateException if called in replay state, or if any behavior is already defined on the mock
     *                 object.
     */
    ...
    /**
     * Same as {@link MockControl#setReturnValue(Object)}. For explanation, see "Convenience Methods for Return Values"
     * in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setReturnValue(Object, Range)}. For explanation, see "Convenience Methods for Return
     * Values" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setReturnValue(Object, int)}. For explanation, see "Convenience Methods for Return
     * Values" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setReturnValue(Object, int, int)}. For explanation, see "Convenience Methods for
     * Return Values" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setThrowable(Throwable)}. For explanation, see "Convenience Methods for Throwables"
     * in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setThrowable(Throwable, Range)}. For explanation, see "Convenience Methods for
     * Throwables" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setThrowable(Throwable, int)}. For explanation, see "Convenience Methods for
     * Throwables" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setThrowable(Throwable, int, int)}. For explanation, see "Convenience Methods for
     * Throwables" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setDefaultReturnValue(Object)}. For explanation, see "Convenience Methods for Return
     * Values" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
    ...
    /**
     * Same as {@link MockControl#setDefaultThrowable(Throwable)}. For explanation, see "Convenience Methods for
     * Throwables" in the EasyMock documentation.
     * 
     * @param ignored an ignored value.
     */
