...
public class AnswerTest {
    ...
    public void answer() {
        ...
        expect(mock.threeArgumentMethod(1, "2", "3")).andAnswer(firstAnswer).andReturn("Second call").andAnswer(
                secondAnswer).andReturn("Fourth call");
    ...
    public void stubAnswer() {
        ...
        IAnswer secondAnswer = new IAnswer() {
            public Object answer() {
                assertEquals(new Object[] { 1, "2", "4" }, getCurrentArguments());
                return "Call answered";
            }
        };
