...
/**
 * Allows setting expectations for an associated expected invocation. Implementations of this interface are returned by
...
public interface IExpectationSetters<T> {
    ...
    /**
     * Sets an object that will be used to calculate the answer for the expected invocation (either return a value, or
     * throw an exception).
     * 
     * @param answer the object used to answer the invocation.
     * @return this object to allow method call chaining.
     */
    ...
    /**
     * Sets a stub object that will be used to calculate the answer for the expected invocation (either return a value,
     ...
     * 
     * @param count the number of invocations expected.
     * @return this object to allow method call chaining.
     */
    IExpectationSetters<T> times(int count);

    /**
     * Expect the last invocation between <code>min</code> and <code>max</code> times.
     * 
     * @param min the minimum number of invocations expected.
     * @param max the maximum number of invocations expected.
     * @return this object to allow method call chaining.
     */
