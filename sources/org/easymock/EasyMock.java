...
public class EasyMock {
     ...
     * object will return <code>0</code>, <code>null</code> or <code>false</code> for unexpected invocations.
     * 
     * @param <T> the interface that the mock object should implement.
     * @param toMock the class of the interface that the mock object should implement.
     * @return the mock object.
    ...
    /**
     * Creates a control, order checking is disabled by default, and the mock objects created by this control will
     * return <code>0</code>, <code>null</code> or <code>false</code> for unexpected invocations.
     * 
     * @return the control.
     */
    ...
    /**
     * Returns the arguments of the current mock method call, if inside an <code>IAnswer</code> callback - be careful
     * here, reordering parameters of method changes the semantics of your tests.
     * 
     * @return the arguments of the current mock method call.
     * @throws IllegalStateException if called outside of <code>IAnswer</code> callbacks.
     */
