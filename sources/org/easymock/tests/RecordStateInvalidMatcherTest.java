...
public class RecordStateInvalidMatcherTest {
    ...
    public void setMatcherBeforeCallingMethods() {
        try {
            ...
            assertEquals("method call on the mock needed before setting matcher", expected.getMessage());
        }
    }
    ...
    public void setMatcherTwice() {
        ...
        try {
            ...
            assertEquals("for method simpleMethod(), a matcher has already been set", expected.getMessage());
        }
    }
    ...
    public void setMatcherTwice2() {
        ...
        try {
            ...
            assertEquals("for method simpleMethodWithArgument(...), a matcher has already been set", expected
                    .getMessage());
        }
    }
