...
public class InvocationTest {
    ...
    @Test
    public void testShouldDisplayMocksToStringIfValidJavaIdentifier() throws SecurityException, NoSuchMethodException {
        class ToString {
        ...
        assertEquals(invocation.toString(new EqualsMatcher()), "validJavaIdentifier.aMethod()");
