...
public class RecordStateMethodCallMissingTest {
    ...
    public void setBooleanReturnValueWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting return value", expected.getMessage());
        }
    }
    ...
    public void setVoidCallableWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting void callable", expected.getMessage());
        }
    }
    ...
    public void setThrowableWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting Throwable", expected.getMessage());
        }
    }
    ...
    public void setBooleanDefaultReturnValueWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting default return value", expected.getMessage());
        }
    }
    ...
    public void setDefaultVoidCallableWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting default void callable", expected.getMessage());
        }
    }
    ...
    public void setDefaultThrowableWithoutMethodCall() {
        try {
            ...
            assertEquals("method call on the mock needed before setting default Throwable", expected.getMessage());
        }
    }
